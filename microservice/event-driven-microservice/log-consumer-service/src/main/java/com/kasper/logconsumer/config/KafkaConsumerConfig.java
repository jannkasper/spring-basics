package com.kasper.logconsumer.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, LogEvent> consumerFactory() {
        ...
        // Trust all types for deserialization
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JsonDeserializer.TYPE_MAPPINGS, "logEvent:com.kasper.logconsumer.model.LogEvent");
        
        // Disable type headers and use the default type
