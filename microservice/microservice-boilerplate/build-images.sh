...
echo "- config-service:${VERSION} and config-service:latest"
echo "- discovery-service:${VERSION} and discovery-service:latest"
echo "- sample-service:${VERSION} and sample-service:latest"
echo "- gateway-service:${VERSION} and gateway-service:latest" 