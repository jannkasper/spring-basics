...
public class AvroBasicsApplication {

	private static final Logger logger = LoggerFactory.getLogger(AvroBasicsApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(AvroBasicsApplication.class, args);
	}
